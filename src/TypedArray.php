...
class TypedArray extends TypedAbstract implements ArrayAccess
{
	 ...
	 * A child class must override _type rather than it being set with the constructor.
	 *
	 * @var string
	 */
	 ...
	 * Constructor.
	 *
	 * If this class is instantiated directly, ie. "$a = new TypedArray('int', [1, 2, 3]);",
	 ...
	 * the class, ie. "protected $_type = 'int';", and $param1 can be the initial data.
	 *
...
//			}
	 ...
	 * * $offset is set and is null;
	 * * $offset is set and has a value;
	 *
	...
	/**
	 * DefinedDefined by the ArrayAccess interface.
	 *
	 * @param string|int $offset
	 */
